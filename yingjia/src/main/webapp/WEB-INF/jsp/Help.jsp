		...
		* {
		...
		.rides-cs {
			...
			.rides-cs .btnOpen, .rides-cs .btnCtn {
				...
				top: 25px;
				left: 0;
				background-image: url("../BfAssets/Content/images/jw/qqkefu.png"/*tpa=http://www.ying158.com/Content/images/jw/qqkefu.png*/);
...
<script>
    ...
    $("http://www.ying158.com/Home/.helpCenter .left").on("click", ".item", function () {
        ...
        if (className.indexOf("active") >= 0) {
            ...
            $("http://www.ying158.com/Home/.helpCenter .left .item").removeClass("active");
    ...
    <style type="text/css">
        ...
        .ft_sns_list .ico_sns{ display: block; width: 62px; height: 62px; margin: 0 auto; background: url("../BfAssets/images/ft_sns.png"/*tpa=http://www.ying158.com/images/ft_sns.png*/) no-repeat;}
