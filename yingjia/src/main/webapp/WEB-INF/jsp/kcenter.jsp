...
<div class="container">
    <div class="kcenter">
        <ul>
            <li><a href="javascript:if(confirm('http://pro.ying158.com/subject  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://pro.ying158.com/subject'" tppabs="http://pro.ying158.com/subject">产品中心</a></li>
            <li><a href="NewsCenter.htm" tppabs="http://www.ying158.com/Home/NewsCenter">新闻中心</a></li>
            <li><a href="javascript:if(confirm('http://pro.ying158.com/mobileappdownload  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://pro.ying158.com/mobileappdownload'" tppabs="http://pro.ying158.com/mobileappdownload">下载中心</a></li>
            <li><a href="Help-1.htm" tppabs="http://www.ying158.com/home/Help">盈+商学院</a></li>
            <li><a href="../UserGuide/TradingSoftware.htm" tppabs="http://www.ying158.com/UserGuide/TradingSoftware">投研中心</a></li>
            <li><a href="javascript:if(confirm('http://pro.ying158.com/account/trades/profit/records  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://pro.ying158.com/account/trades/profit/records'" tppabs="http://pro.ying158.com/account/trades/profit/records">我的加法库</a></li>
        </ul>
        <div style="position:absolute;left:485px;top:410px;font-size:18px;">
            <a href="../UserGuide/TradingSoftware.htm" tppabs="http://www.ying158.com/UserGuide/TradingSoftware" style="color: transparent">投研中心</a>
        </div>
        <div style="position:absolute;left:720px;top:390px;font-size:18px;">
            <a href="javascript:if(confirm('http://pro.ying158.com/account/trades/profit/records  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://pro.ying158.com/account/trades/profit/records'" tppabs="http://pro.ying158.com/account/trades/profit/records" style="color: transparent">我的加法库</a>
        </div>
        <div style="position:absolute;right:50px;top:220px;font-size:18px;">
            <a href="#" onclick="$('#feedbackModal').modal(); return false;" style="color: transparent">投诉与建议</a>
        </div>
    ...
    <style type="text/css">
        ...
        .ft_sns_list .ico_sns{ display: block; width: 62px; height: 62px; margin: 0 auto; background: url("../BfAssets/images/ft_sns.png"/*tpa=http://www.ying158.com/images/ft_sns.png*//*tpa=http://www.ying158.com/images/ft_sns.png*/) no-repeat;}
