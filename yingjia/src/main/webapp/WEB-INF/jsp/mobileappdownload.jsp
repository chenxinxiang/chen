...
<script src="../BfAssets/resources/web/echart/dist/echarts.js" tppabs="http://pro.ying158.com/resources/web/echart/dist/echarts.js"></script>	<style type="text/css">
	.down_img{
		position:absolute;
		left:660px;
		top:250px;
...
<script type="text/javascript">
    $(function(){
	 ...
	 <div class="down">
    	<h1>版本：<font color="#9a8140">1.0</font>（build 15）/  大小：<font color="#9a8140">5.3MB</font>  /  2015-10-30</h1>
    	<div class="down_img"><img alt="" src="../BfAssets/resources/images/appdownload.png" tppabs="http://pro.ying158.com/resources/images/appdownload.png" width="150px" height="150px"></div>
    	<div class="down_xz">
    	<a href="javascript:if(confirm('https://itunes.apple.com/cn/app/id1055706298  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��һ��ʹ��δ֧��Э��ĵ�ַ(����: gopher)��  \n\n����Ҫ�ӷ�����������?'))window.location='https://itunes.apple.com/cn/app/id1055706298'" tppabs="http://pro.ying158.com/download/app/ios" target="_black"><i class="iconfont">&#xe623;</i>IOS版本下载</a>
    	<a href="download/app/android" tppabs="http://pro.ying158.com/download/app/android" class="android"><i class="iconfont">&#xe622;</i>安卓版本下载</a>
    	</div>
...
(function() {
  ...
  hm.src = "../hm.baidu.com/hm.js-282435d865729ac986ce327cbc2a51c1"/*tpa=http://hm.baidu.com/hm.js?282435d865729ac986ce327cbc2a51c1*/;
