...
<meta charset=utf-8"utf-8" />
	...
	<link href="/BfAssets/Content/images/jw/icon.ico" type="image/x-icon" rel="shortcut icon">
	<script>

		
	</script>
	<link href="../BfAssets/Content/common-v=Z05m6kwo6inK-VaLsOzp2WprkyHxTqbnfKMT2Jhf3No1.css" tppabs="http://www.ying158.com/Content/common?v=Z05m6kwo6inK-VaLsOzp2WprkyHxTqbnfKMT2Jhf3No1" rel="stylesheet"/>

	<link href="../BfAssets/Content/themes/jw.less.css" tppabs="http://www.ying158.com/Content/themes/jw.less" rel="stylesheet"/>

	<script src="../BfAssets/bundles/jquery-v=NiueT6v-Q3INzuyQmXB5fnjkCocnV77T4f9b_31tz2g1" tppabs="http://www.ying158.com/bundles/jquery?v=NiueT6v-Q3INzuyQmXB5fnjkCocnV77T4f9b_31tz2g1"></script>

	<script src="../BfAssets/bundles/bootstrap-v=uEfKOZsa84kKaOUM1qIxk1aGEbk8upz7Rfga52rg9Es1" tppabs="http://www.ying158.com/bundles/bootstrap?v=uEfKOZsa84kKaOUM1qIxk1aGEbk8upz7Rfga52rg9Es1"></script>
		...
		* {
		...
		.rides-cs {
			...
			.rides-cs .btnOpen, .rides-cs .btnCtn {
				...
				top: 25px;
				left: 0;
				background-image: url("../BfAssets/Content/images/jw/qqkefu.png"/*tpa=http://www.ying158.com/Content/images/jw/qqkefu.png*//*tpa=http://www.ying158.com/Content/images/jw/qqkefu.png*/);
...
<div id="floatTools" class="rides-cs" style="height:408px;">
		...
		<div id="divFloatToolsView" class="floatR" style="display: none;height:408px;width: 140px;">
			<div class="cn">
				<img src="../BfAssets/Content/images/jw/kefun.png" tppabs="http://www.ying158.com/Content/images/jw/kefun.png" style="  width: 100px;display: block; margin: 0 auto; padding-top: 10px;"/>
				<h3 class="titZx">盈+金融在线客服</h3>
				<ul>
					<li><span>客服1</span> <a target="_blank" href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=508886246&site=qq&menu=yes  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://wpa.qq.com/msgrd?v=3&uin=508886246&site=qq&menu=yes'" tppabs="http://wpa.qq.com/msgrd?v=3&uin=508886246&site=qq&menu=yes"><img border="0" src="../BfAssets/Content/images/jw/littleQQ.png" tppabs="http://www.ying158.com/Content/images/jw/littleQQ.png" alt="点击这里给我发消息" title="点击这里给我发消息" /></a> </li>
					<li><span>客服2</span> <a target="_blank" href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=3276064217&site=qq&menu=yes  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://wpa.qq.com/msgrd?v=3&uin=3276064217&site=qq&menu=yes'" tppabs="http://wpa.qq.com/msgrd?v=3&uin=3276064217&site=qq&menu=yes"><img border="0" src="../BfAssets/Content/images/jw/littleQQ.png" tppabs="http://www.ying158.com/Content/images/jw/littleQQ.png" alt="点击这里给我发消息" title="点击这里给我发消息" /></a> </li>
					<li><span>客服3</span> <a target="_blank" href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=2717994963&site=qq&menu=yes  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://wpa.qq.com/msgrd?v=3&uin=2717994963&site=qq&menu=yes'" tppabs="http://wpa.qq.com/msgrd?v=3&uin=2717994963&site=qq&menu=yes"><img border="0" src="../BfAssets/Content/images/jw/littleQQ.png" tppabs="http://www.ying158.com/Content/images/jw/littleQQ.png" alt="点击这里给我发消息" title="点击这里给我发消息" /></a> </li>
                    <li><span>技术A</span> <a target="_blank" href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=2088636909&site=qq&menu=yes  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://wpa.qq.com/msgrd?v=3&uin=2088636909&site=qq&menu=yes'" tppabs="http://wpa.qq.com/msgrd?v=3&uin=2088636909&site=qq&menu=yes"><img border="0" src="../BfAssets/Content/images/jw/littleQQ.png" tppabs="http://www.ying158.com/Content/images/jw/littleQQ.png" alt="点击这里给我发消息" title="点击这里给我发消息" /></a> </li>
...
<link href="../BfAssets/Scripts/plugins/video-js/video-js.css" tppabs="http://www.ying158.com/Scripts/plugins/video-js/video-js.css" rel="stylesheet" type="text/css">
<!-- video.js must be in the <head> for older IEs to work. -->
<script src="../BfAssets/Scripts/plugins/video-js/video.js" tppabs="http://www.ying158.com/Scripts/plugins/video-js/video.js"></script>
<!-- Unless using the CDN hosted version, update the URL to the Flash SWF -->
<script>
    videojs.options.flash.swf = "video-js.swf"/*tpa=http://www.ying158.com/video-js.swf*/;
</script>
...
<div id="homebanner" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
                <div class=" item active">
                    <img src="../BfAssets/Content/images/banner2.jpg" tppabs="http://www.ying158.com/Content/images/banner2.jpg" alt="[]" />
    ...
    <div class="login-box">
        ...
        <div class="block" style=" height:280px;">
            ...
            <a style="float:none; margin:0 auto; margin-left:15px;    display: inline-block;margin-bottom: 10px;" href="/yingjia/item2/login" tppabs="http://pro.ying158.com/web/login"><img src="../BfAssets/images/ying_index_login_btn.png" tppabs="http://www.ying158.com/images/ying_index_login_btn.png" /></a>
            <a style="float:none; margin:0 auto; margin-left:15px; margin-top:10px;" href="/yingjia/item2/Register" tppabs="http://pro.ying158.com/web/regis"><img src="../BfAssets/images/ying_index_reg_btn.png" tppabs="http://www.ying158.com/images/ying_index_reg_btn.png" /></a>
...
<div class="container index">
    <div class="row">
        <div class="report">
            ...
            <a href="/yingjia/item2/NewsCenter" tppabs="http://www.ying158.com/home/newscenter">
                查看更多>>&nbsp;&nbsp;&nbsp;&nbsp;
            </a>
        </div>
<!--         <iframe src="/yingJiaProfitow/frontTopIframe" scrolling="no"这个给我一下></iframe> -->
...
<!-- 						</a> -->
            ...
            <div class="title">
                <img src="../BfAssets/Content/images/jw/applyLeft.png" tppabs="http://www.ying158.com/Content/images/jw/applyLeft.png" />合作商风采<img src="../BfAssets/Content/images/jw/applyRight.png" tppabs="http://www.ying158.com/Content/images/jw/applyRight.png" />
            </div>
            <div id="introMarquee">
                <div id="marqueeContainer">
                    <ul id="articleImgs" class="unstyled" style="  background-color: #917739;padding-top: 10px;">
                        <li>
                            <img src="../BfAssets/Content/images/jw/hezuo1.jpg" tppabs="http://www.ying158.com/Content/images/jw/hezuo1.jpg" name="hezuo1Big.jpg">
                        </li>
                        <li>
                            <img src="../BfAssets/Content/images/jw/hezuo2.jpg" tppabs="http://www.ying158.com/Content/images/jw/hezuo2.jpg" name="hezuo2Big.jpg">
                        </li>
                        <li>
                            <img src="../BfAssets/Content/images/jw/hezuo3.jpg" tppabs="http://www.ying158.com/Content/images/jw/hezuo3.jpg" name="hezuo3Big.jpg">
                        </li>
                        <li>
                            <img src="../BfAssets/Content/images/jw/hezuo4.jpg" tppabs="http://www.ying158.com/Content/images/jw/hezuo4.jpg" name="hezuo4Big.jpg">
                        </li>
                        <li>
                            <img src="../BfAssets/Content/images/jw/hezuo5.jpg" tppabs="http://www.ying158.com/Content/images/jw/hezuo5.jpg" name="hezuo5Big.jpg">
                        </li>
                        <li>
                            <img src="../BfAssets/Content/images/jw/hezuo6.jpg" tppabs="http://www.ying158.com/Content/images/jw/hezuo6.jpg" name="hezuo6Big.jpg">
                        </li>
                        <li>
                            <img src="../BfAssets/Content/images/jw/hezuo7.jpg" tppabs="http://www.ying158.com/Content/images/jw/hezuo7.jpg" name="hezuo7Big.jpg">
                        </li>
                        <li>
                            <img src="../BfAssets/Content/images/jw/hezuo8.jpg" tppabs="http://www.ying158.com/Content/images/jw/hezuo8.jpg" name="hezuo8Big.jpg">
                        </li>
                    </ul>
...
<div class="bottomAd" style="position:fixed; bottom:0px; margin:0 auto;">
    ...
    <img src="../BfAssets/ying158.com/images/yingjia.png" tppabs="http://ying158.com/images/yingjia.png" border="0" usemap="#Map" />
    <map name="Map" id="Map">
        <area shape="rect" coords="1420,23,1445,48" href="javascript:hide();" />
    </map>
</div>

            <script src="../BfAssets/Scripts/knockout-3.2.0.js" tppabs="http://www.ying158.com/Scripts/knockout-3.2.0.js"></script>
            <script>
    $("#marqueeContainer img").click(function () {
        var bigImg = $(this).attr("name");
        var url = "../BfAssets/Content/images/jw/" + bigImg;
    ...
    var loginFromPage = function () {
        ...
        $.post("/api/authentication/signIn", { login: phone, password: password }, function (data) {
            if (data.isAuthenticated) {
                window.location.href = 'Account/Login-1.htm'/*tpa=http://www.ying158.com/account/UserCenter*/;
            } else {
...
<script>
    ...
    (function () {
        ...
        hm.src = "../hm.baidu.com/hm.js-3a07c2531807d298ad88175fa22f9413"/*tpa=http://hm.baidu.com/hm.js?3a07c2531807d298ad88175fa22f9413*/;
		...
		<div class="container index">
			<div class="row">
				<div class="security">
					<div class="item">
						<img src="../BfAssets/Content/images/jw/indexSecurity1.png" tppabs="http://www.ying158.com/Content/images/jw/indexSecurity1.png" />
						<div class="detail">
							资金银行监管
							<div class="desc">
								平台资金由第三方银行监管
					...
					<div class="item">
						<img src="../BfAssets/Content/images/jw/indexSecurity2.png" tppabs="http://www.ying158.com/Content/images/jw/indexSecurity2.png" />
						<div class="detail">
							交易证监会监管
							<div class="desc">
								投资交易由证监会监管
					...
					<div class="item">
						<img src="../BfAssets/Content/images/jw/indexSecurity3.png" tppabs="http://www.ying158.com/Content/images/jw/indexSecurity3.png" />
						<div class="detail">
							风控盈+监管
							<div class="desc">
								盈+全自动风控系统为您保驾护航
    ...
    <style type="text/css">
        ...
        .ft_sns_list .ico_sns{ display: block; width: 62px; height: 62px; margin: 0 auto; background: url("images/ft_sns.png"/*tpa=http://www.ying158.com/images/ft_sns.png*//*tpa=http://www.ying158.com/images/ft_sns.png*/) no-repeat;}
		...
		<div class="container">
            <div class="row">
                <div class="hzhb_box">
                    ...
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.picc.com/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.picc.com/'" tppabs="http://www.picc.com/"><img onmouseover="this.src = '../BfAssets/images/hzhb/1_on.png'/*tpa=http://www.ying158.com/images/hzhb/1_on.png*/" onmouseout="this.src = '../BfAssets/images/hzhb/1.jpg'/*tpa=http://www.ying158.com/images/hzhb/1.jpg*/" src="../BfAssets/images/hzhb/1.jpg" tppabs="http://www.ying158.com/images/hzhb/1.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.fuioupay.com/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.fuioupay.com/'" tppabs="http://www.fuioupay.com/"><img onmouseover="this.src = '../BfAssets/images/hzhb/2_on.png'/*tpa=http://www.ying158.com/images/hzhb/2_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/2.jpg'/*tpa=http://www.ying158.com/images/hzhb/2.jpg*/" src="../BfAssets/images/hzhb/2.jpg" tppabs="http://www.ying158.com/images/hzhb/2.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.nanhua.net/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.nanhua.net/'" tppabs="http://www.nanhua.net/"><img onmouseover="this.src = '../BfAssets/images/hzhb/3_on.png'/*tpa=http://www.ying158.com/images/hzhb/3_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/3.jpg'/*tpa=http://www.ying158.com/images/hzhb/3.jpg*/" src="../BfAssets/images/hzhb/3.jpg" tppabs="http://www.ying158.com/images/hzhb/3.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.zttrust.com.cn/stations/526623d20a/index.php/5268e6b50a  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.zttrust.com.cn/stations/526623d20a/index.php/5268e6b50a'" tppabs="http://www.zttrust.com.cn/stations/526623d20a/index.php/5268e6b50a"><img onmouseover="this.src = '../BfAssets/images/hzhb/4_on.png'/*tpa=http://www.ying158.com/images/hzhb/4_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/4.jpg'/*tpa=http://www.ying158.com/images/hzhb/4.jpg*/" src="../BfAssets/images/hzhb/4.jpg" tppabs="http://www.ying158.com/images/hzhb/4.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://sc.hkex.com.hk/TuniS/www.hkex.com.hk/eng/index.htm/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://sc.hkex.com.hk/TuniS/www.hkex.com.hk/eng/index.htm/'" tppabs="http://sc.hkex.com.hk/TuniS/www.hkex.com.hk/eng/index.htm/"><img onmouseover="this.src = '../BfAssets/images/hzhb/5_on.png'/*tpa=http://www.ying158.com/images/hzhb/5_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/5.jpg'/*tpa=http://www.ying158.com/images/hzhb/5.jpg*/" src="../BfAssets/images/hzhb/5.jpg" tppabs="http://www.ying158.com/images/hzhb/5.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.cmegroup.com/cn-s/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.cmegroup.com/cn-s/'" tppabs="http://www.cmegroup.com/cn-s/"><img onmouseover="this.src = '../BfAssets/images/hzhb/6_on.png'/*tpa=http://www.ying158.com/images/hzhb/6_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/6.jpg'/*tpa=http://www.ying158.com/images/hzhb/6.jpg*/" src="../BfAssets/images/hzhb/6.jpg" tppabs="http://www.ying158.com/images/hzhb/6.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.sgx.com/wps/portal/sgxweb_ch/home/!ut/p/a1/04_Sj9CPykssy0xPLMnMz0vMAfGjzOKNHB1NPAycDSz9wwzMDTxD_Z2Cg8PCDANdjYEKIoEKDHAARwNC-sP1o8BK8JhQkBthkO6oqAgAzDYPQQ!!/dl5/d5/L2dBISEvZ0FBIS9nQSEh/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.sgx.com/wps/portal/sgxweb_ch/home/!ut/p/a1/04_Sj9CPykssy0xPLMnMz0vMAfGjzOKNHB1NPAycDSz9wwzMDTxD_Z2Cg8PCDANdjYEKIoEKDHAARwNC-sP1o8BK8JhQkBthkO6oqAgAzDYPQQ!!/dl5/d5/L2dBISEvZ0FBIS9nQSEh/'" tppabs="http://www.sgx.com/wps/portal/sgxweb_ch/home/!ut/p/a1/04_Sj9CPykssy0xPLMnMz0vMAfGjzOKNHB1NPAycDSz9wwzMDTxD_Z2Cg8PCDANdjYEKIoEKDHAARwNC-sP1o8BK8JhQkBthkO6oqAgAzDYPQQ!!/dl5/d5/L2dBISEvZ0FBIS9nQSEh/"><img onmouseover="this.src = '../BfAssets/images/hzhb/7_on.png'/*tpa=http://www.ying158.com/images/hzhb/7_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/7.jpg'/*tpa=http://www.ying158.com/images/hzhb/7.jpg*/" src="../BfAssets/images/hzhb/7.jpg" tppabs="http://www.ying158.com/images/hzhb/7.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.neeq.com.cn/index/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.neeq.com.cn/index/'" tppabs="http://www.neeq.com.cn/index/"><img onmouseover="this.src = '../BfAssets/images/hzhb/8_on.png'/*tpa=http://www.ying158.com/images/hzhb/8_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/8.jpg'/*tpa=http://www.ying158.com/images/hzhb/8.jpg*/" src="../BfAssets/images/hzhb/8.jpg" tppabs="http://www.ying158.com/images/hzhb/8.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.cmbchina.com/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.cmbchina.com/'" tppabs="http://www.cmbchina.com/"><img onmouseover="this.src = '../BfAssets/images/hzhb/9_on.png'/*tpa=http://www.ying158.com/images/hzhb/9_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/9.jpg'/*tpa=http://www.ying158.com/images/hzhb/9.jpg*/" src="../BfAssets/images/hzhb/9.jpg" tppabs="http://www.ying158.com/images/hzhb/9.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.bankcomm.com/BankCommSite/default.shtml  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.bankcomm.com/BankCommSite/default.shtml'" tppabs="http://www.bankcomm.com/BankCommSite/default.shtml"><img onmouseover="this.src = '../BfAssets/images/hzhb/10_on.png'/*tpa=http://www.ying158.com/images/hzhb/10_on.png*/" onmouseout="this.src = '../BfAssets/images/hzhb/10.jpg'/*tpa=http://www.ying158.com/images/hzhb/10.jpg*/" src="../BfAssets/images/hzhb/10.jpg" tppabs="http://www.ying158.com/images/hzhb/10.jpg" /></a></div>

                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.ccb.com/cn/home/index.html  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.ccb.com/cn/home/index.html'" tppabs="http://www.ccb.com/cn/home/index.html"><img onmouseover="this.src = '../BfAssets/images/hzhb/11_on.png'/*tpa=http://www.ying158.com/images/hzhb/11_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/11.jpg'/*tpa=http://www.ying158.com/images/hzhb/11.jpg*/" src="../BfAssets/images/hzhb/11.jpg" tppabs="http://www.ying158.com/images/hzhb/11.jpg" /></a></div>
                    <div class="hzhb_item"><a target="_blank" href="javascript:if(confirm('http://www.icbc.com.cn/icbc/  \n\n���ļ�δ�� Teleport Pro ���أ���Ϊ ��λ����ʼ��ַ�����õı߽���������·���С�  \n\n����Ҫ�ӷ�����������?'))window.location='http://www.icbc.com.cn/icbc/'" tppabs="http://www.icbc.com.cn/icbc/"><img onmouseover="this.src = '../BfAssets/images/hzhb/12_on.png'/*tpa=http://www.ying158.com/images/hzhb/12_on.png*/" onmouseout="    this.src = '../BfAssets/images/hzhb/12.jpg'/*tpa=http://www.ying158.com/images/hzhb/12.jpg*/" src="../BfAssets/images/hzhb/12.jpg" tppabs="http://www.ying158.com/images/hzhb/12.jpg" /></a></div>
                </div>
                    ...
                    <ul style=" margin-bottom:0px;" class="ft_sns_list clearfix">
                        <li>
                            <div class="wx_tips j_tips">
                                ...
                                <div class="tips_bd">
                                    <em class="arrow"></em>
                                    <img src="../BfAssets/images/yj.jpg" tppabs="http://www.ying158.com/images/yj.jpg" alt="微信公共平台">
                                </div>
                            </div>
                        </li>
                        <li>
			...
			<div class="modal-content" style="width:400px;">
				...
				<div class="modal-body text-center">
					...
					<div>
						...
						<a class="btn btn-info" href="Account/Regist.htm" tppabs="http://www.ying158.com/Account/Regist" target="blank" style="padding-left:20px;padding-right:20px;margin-left:20px;">注册</a>
					</div>
				</div>
			</div>
		</div>
...
(function() {
  var hm = document.createElement("script");
  hm.src = "../hm.baidu.com/hm.js-bb6cf2322300378a89a69641641427c0"/*tpa=http://hm.baidu.com/hm.js?bb6cf2322300378a89a69641641427c0*/;
  var s = document.getElementsByTagName("script")[0];
  s.parentNode.insertBefore(hm, s);
})();
    </script>
