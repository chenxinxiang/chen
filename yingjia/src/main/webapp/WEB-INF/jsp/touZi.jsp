...
<link href="http://pro.ying158.com/resources/web/images/icon.ico" type="image/x-icon" rel="shortcut icon">
	...
	<link href="/yingjia/BfAssets/css/iconfont.css" rel="stylesheet" type="text/css">
	<link href="/yingjia/BfAssets/css/common.css" rel="stylesheet">
	<link href="/yingjia/BfAssets/css/jw2.css" rel="stylesheet">
	
    <script src="/yingjia/BfAssets/js/hm.js"></script>
    <script src="/yingjia/BfAssets/js/jquery.js"></script>
    <script src="/yingjia/BfAssets/js/echarts.js"></script>
</head>
<body>
    ...
    <tbody><tr>
        <td align="left" valign="middle" class="info">
            <a href="http://pro.ying158.com/account/security">
                <div class="img"><img src="/yingjia/BfAssets/img/userPic.jpg"></div>
                <h2>shenxiang，<span>您好!</span></h2>
            </a>
...
<div class="countBox">
    <ul>
        <li><h2>357.3700</h2><p>账户可用余额(元)<a href="javascript:;" class="iconfont"><span>账户可用余额</span><i></i></a></p></li>
        <li><h2>639.37</h2><p>账户总资产(元)<a href="javascript:;" class="iconfont"><span>可用余额+投资金额+累计收益</span><i></i></a></p></li>
        <li><h2 style="color:#9d8440">282.0000</h2><p>投资金额(元)<a href="javascript:;" class="iconfont"><span>投资中资金</span><i></i></a></p></li>
        <li><h2 style="color:#9d8440">2.9836</h2><p>累计收益(元)<a href="javascript:;" class="iconfont"><span>累计收益</span><i></i></a></p></li>
        <li><h2 style="color:#9d8440">182.0000</h2><p>冻结金额(元)<a href="javascript:;" class="iconfont"><span>提现冻结金额</span><i></i></a></p></li>
    </ul>
    <a href="/yingjia/memberCenter/cz" class="cz">充值</a>
    <a href="/yingjia/memberCenter/tiKuan" class="tk">提款</a>
</div>    <div class="proMain clearfix">
<div class="adminLeft">
    <h2>我的投资</h2>
    <ul>
        <li><a id="member_center_menu_invests" href="/yingjia/memberCenter/list" class="select"><em class="iconfont red"></em>投资记录</a></li>
<!--         <li><a id="member_center_menu_profit_record" href="/yingjia/myadd"><em class="iconfont red"></em>收益记录</a></li> -->
        <li><a id="member_center_menu_deposit_record" href="/yingjia/mem/Record"><em class="iconfont red"></em>充值记录</a></li>
        <li><a id="member_center_menu_withdraw_record" href="/yingjia/mem/Wrecor"><em class="iconfont red"></em>提款记录</a></li>
        <li><a id="member_center_menu_bbinInfo_record" href="/yingjia/memberCenter/tiyanj"><em class="iconfont red"></em>体验金记录</a></li>
    </ul>
    <h2>我的账户</h2>
    <ul>
         <li><a id="member_center_menu_deposit" href="/yingjia/fontmember/czjl"><em class="iconfont"></em>账户充值</a></li>
        <li><a id="member_center_menu_security" href="/yingjia/fontmember/safe"><em class="iconfont"></em>安全信息</a></li>
        <li><a id="member_center_menu_withdraw" href="/yingjia/fontmember/woyaotikuan"><em class="iconfont"></em>我要提款</a></li>
    </ul>
</div>
<script>
