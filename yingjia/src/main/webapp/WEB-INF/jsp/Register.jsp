...
<script src="../BfAssets/resources/web/echart/dist/echarts.js" tppabs="http://pro.ying158.com/resources/web/echart/dist/echarts.js"></script></head>
<body>
    ...
    <div class="row">
        ...
        <div class="telInfo">
            ...
            <div class="detail">
                        ...
                        <a style="font-size:18px;float:right;margin-top:5px;color:#917739;" href="login.htm" tppabs="http://pro.ying158.com/web/login">登录</a>
                        <a style="font-size:18px;float:right;margin-right:15px;margin-top:5px;color:#917739;" href="regis.htm" tppabs="http://pro.ying158.com/web/regis">注册</a>
                <br>4000-999-158
            </div>
        </div>
    </div>
...
<!-- 		</div> -->
		...
		<div class="item">
			...
			<div class="rInput loginChoose">
				我已经注册，现在就<a href="login.htm" tppabs="http://pro.ying158.com/web/login">登录</a>
			</div>
		</div>
	</div>
	
<script type="text/javascript" src="../BfAssets/resources/web/js/regis.js" tppabs="http://pro.ying158.com/resources/web/js/regis.js"></script>
<script type="text/javascript">
$(function(){
	var b = "";
	regis(b);
...
function showAgreement(){
	window.open("zcxy.htm"/*tpa=http://pro.ying158.com/web/zcxy*/,"注册协议","height=800,width=1000,scrollbars=yes, resizable=no,location=no, status=no,screenX=100") 
}
</script>
<meta charset="UTF-8">
    <div class="security">
