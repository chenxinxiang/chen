            ...
            <div class="row login">
                ...
                <div class="loginBlock">
                    ...
                    <div class="item item1">
                        ...
                        <div class="lInput">
                            <img src="../BfAssets/resources/web/images/userIcon.png" tppabs="http://pro.ying158.com/resources/web/images/userIcon.png" /><input type="text" placeholder="手机号" id="phone" name="phone" class="form-control phone" /><span class="errorInfo">用户名不能为空</span>
                        </div>
                    </div>
                    <div class="item">
                        <div class="lLabel">
                        ...
                        <div class="lInput">
                            <img src="../BfAssets/resources/web/images/passwordIcon.png" tppabs="http://pro.ying158.com/resources/web/images/passwordIcon.png" /><input type="password" placeholder="密码" id="password" name="password" class="form-control password" /><span class="errorInfo"></span>
                        </div>
                    </div>
                    <div class="rest">
                        <p class="error"></p>
