...
<link href="http://pro.ying158.com/resources/web/images/icon.ico" type="image/x-icon" rel="shortcut icon">
	...
	<link href="/yingjia/BgAfssets/css/pager.css" rel="stylesheet">
	<script src="/yingjia/BgAfssets/js/pager.js"></script>
...
<!--         <li><a id="member_center_menu_profit_record" href="/yingjia/myadd"><em class="iconfont red"></em>收益记录</a></li> -->
        <li><a id="member_center_menu_deposit_record" href="/yingjia/memberCenter/cz"><em class="iconfont red"></em>充值记录</a></li>
        <li><a id="member_center_menu_withdraw_record" href="/yingjia/memberCenter/tiKuan"><em class="iconfont red"></em>提款记录</a></li>
...
<div class="ajaxContainer">
	...
	<td>${list.amount}</td>
	<td>
	<c:if test="${list.status==0}">待付款</c:if>
